...
- una seconda sala, meno ampia, posta davanti agli sportelli,
  in cui si può entrare solo a gruppi di k persone (oltre alle persone servite agli sportelli)
...
- si preveda di far entrare tutte le persone nell'ufficio postale, all'inizio del programma
 ...
 Facoltativo: prevedere il caso di un flusso continuo di clienti
 e la possibilità che l'operatore chiuda lo sportello stesso dopo che in un certo
...
public class MainClass {
    public static void main(String[] args){
        ...
        UfficioPostale Ufficio = new UfficioPostale(n, k);
        Ufficio.Apertura();
        Ufficio.Chiusura();
    }
}
