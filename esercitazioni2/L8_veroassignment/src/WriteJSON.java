...
public class WriteJSON {
    ...
    private final static String[] nomi = { "anna", "anna1", "anna2", "anna3", "anna4", "anna5",
                                           "anna6", "anna7", "anna8", "anna9" };
    private final static String[] cognomi = { "nana",};
    ...
    private static Account newRandAcc(){
        ...
        String fullname = (names[(int) (Math.random() * names.length)] + " " + surnames[(int) (Math.random() * surnames.length)]);
